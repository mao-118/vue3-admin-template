...
// // 初始化地图
// const initMap = () => {
//   mapObj.viewMap = new window.AMap.Map('container', {
//     zoom: 11, // 级别
//     // center: null, // 中心点坐标
...
//     viewMode: '3D', // 使用3D视图
//   })
//   mapObj.marker = new window.AMap.Marker({
//     // 创建标记点
...
//   // 获取地址 注册地理编码插件和定位插件。
//   window.AMap.plugin(['AMap.Geocoder', 'AMap.Geolocation', 'AMap.ToolBar'], () => {
//     mapObj.geocoder = new window.AMap.Geocoder({
//       // 地理编码对象
//       radius: 1000,
//       extensions: 'all',
//     })
...
//     })
//     // 工具条对象
//     ;(mapObj.viewMap as any).addControl(toolBar)
//     // 定位对象
//     mapObj.geolocation = new window.AMap.Geolocation({
//       // 是否使用高精度定位，默认：true
...
//     }) // 绑定定位事件
//     ;(mapObj.geolocation as any).on('complete', onComplete)
//     ;(mapObj.geolocation as any).on('error', onError)
//     // 地图添加定位组件
//     ;(mapObj.viewMap as any).addControl(mapObj.geolocation)
//   })
//   ;(mapObj.viewMap as any).on('click', clickHandler) // 绑定点击事件
//   ;(mapObj.viewMap as any).add(mapObj.marker) // 添加标记对象
//   // 创建定位组件
// }
// // 地图点击
...
//   ;(mapObj.marker as any).setPosition([e.lng, e.lat])
// }
// // 通过坐标获取地址
// const getAddress = (e: any) => {
//   ;(mapObj.geocoder as any).getAddress([e.lng, e.lat], (status: any, result: any) => {
//     if (status === 'complete' && result.info === 'OK') {
//       if (result && result.regeocode) {
//         const address = result.regeocode.formattedAddress // 获取到位置
//         // 修改标记点的title
//         ;(mapObj.marker as any).setTitle(address)
//       }
//     }
//   })
// }
...
// // 检索
// const searchPlace = async (queryString: string, cb: any) => {
//   const sig =
//     JSON.stringify({
//       city: '杭州', // 指定区域
...
// }
// // 检索选中
// const selectPlace = (pointInfo: any) => {
//   if (pointInfo.isResultLengthZero) {
//     keyword.value = ''
//     return
//   }
//   // 选中级别设置为最小 精准
//   ;(mapObj.viewMap as any).setZoom(16)
//   // 获取坐标
//   const location = pointInfo.location.split(',')
//   // 更新坐标
//   ;(mapObj.marker as any).setPosition([location[0], location[1]])
//   // 修改标记点的title
//   ;(mapObj.marker as any).setTitle(pointInfo.value)
//   ;(mapObj.viewMap as any).setCenter([location[0], location[1]])
// }
// // 定位成功
